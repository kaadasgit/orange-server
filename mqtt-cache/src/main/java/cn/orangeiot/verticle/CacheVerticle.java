...
public class CacheVerticle extends AbstractVerticle{
    ...
    private static Logger logger = LoggerFactory.getLogger(CacheVerticle.class);
    ...
    public void start(Future<Void> startFuture) throws Exception {
         ...
         * 加载zk config
         */
        InputStream zkIn = CacheVerticle.class.getResourceAsStream("/zkConf.json");
        InputStream configIn = CacheVerticle.class.getResourceAsStream("/config.json");//全局配置
