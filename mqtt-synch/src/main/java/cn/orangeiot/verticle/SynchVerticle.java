...
import cn.orangeiot.handler.RegisterHandler;
...
public class SynchVerticle extends AbstractVerticle{

    private static Logger logger = LoggerFactory.getLogger(SynchVerticle.class);
    ...
    public void start(Future<Void> startFuture) throws Exception {
         ...
         * 加载zk config
         */
        InputStream zkIn = SynchVerticle.class.getResourceAsStream("/zkConf.json");
        InputStream configIn = SynchVerticle.class.getResourceAsStream("/config.json");//全局配置
