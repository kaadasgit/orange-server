...
public class DaoVerticle extends AbstractVerticle{
    ...
    private static Logger logger = LoggerFactory.getLogger(DaoVerticle.class);
    ...
    public void start(Future<Void> startFuture) throws Exception {
         ...
         * 加载zk config
         */
        InputStream zkIn = DaoVerticle.class.getResourceAsStream("/zkConf.json");
        InputStream configIn = DaoVerticle.class.getResourceAsStream("/config.json");//全局配置
